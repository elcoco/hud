...
static void ucd_item_init(UcdItem *item)
{
}

static void ucd_item_class_init(UcdItemClass *class)
{
}

static UcdItem *ucd_item_new(gunichar codepoint, const char *name)
{
    UcdItem *item;
...
static gunichar ucd_item_get_codepoint(UcdItem *item)
{
    return item->codepoint;
}

static const char *ucd_item_get_name(UcdItem *item)
{
    return item->name;
}

static GListModel *ucd_model_new(void)
{
    GBytes *bytes;
    GVariant *v;
    GVariantIter *iter;
...
static void setup_centered_label(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    label = gtk_label_new("");
...
static void setup_label(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    label = gtk_label_new("");
...
static void setup_ellipsizing_label(GtkSignalListItemFactory *factory,
			GObject *listitem)
{
    GtkWidget *label;
    label = gtk_label_new("");
...
static void bind_codepoint(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
...
static void bind_char(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
...
static void bind_type(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
    ...
    gtk_label_set_label(GTK_LABEL(label),
			get_unicode_type_name(g_unichar_type(codepoint)));
}

static void bind_break_type(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
    ...
    gtk_label_set_label(GTK_LABEL(label),
			get_break_type_name(g_unichar_break_type
					    (codepoint)));
}

static void bind_combining_class(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
    ...
    gtk_label_set_label(GTK_LABEL(label),
			get_combining_class_name(g_unichar_combining_class
						 (codepoint)));
}

static void bind_script(GtkSignalListItemFactory *factory, GObject *listitem)
{
    GtkWidget *label;
    GObject *item;
    gunichar codepoint;
...
static void selection_changed(GObject *object, GParamSpec *pspec, GtkWidget *label)
{
    UcdItem *item;
    guint codepoint;
    char buffer[16] = { 0, };
...
GtkWidget *create_ucd_view(GtkWidget *label)
{
    GtkWidget *cv;
...
GtkWidget *do_listview_ucd(GtkWidget *do_widget)
{
	...
	g_object_set_data_full(G_OBJECT(window), "provider", provider,
			       remove_provider);
    }
